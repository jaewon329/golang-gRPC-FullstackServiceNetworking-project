...
const file_serverstreaming_proto_rawDesc = "" +
	"\n" +
	"\x15serverstreaming.proto\x12\x05proto\"#\n" +
	"\aMessage\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\"\x1e\n" +
	"\x06Number\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x05R\x05value2I\n" +
	"\x0fServerStreaming\x126\n" +
	"\x11GetServerResponse\x12\r.proto.Number\x1a\x0e.proto.Message\"\x000\x01B%Z#lec-07-prg-04-serverstreaming/protob\x06proto3"
